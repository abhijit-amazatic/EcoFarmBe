...
class Estimate(TimeStampFlagModelMixin, models.Model):
    ...
    contact_persons_details = JSONField(default=dict, blank=True, null=True)
    salesperson_id = models.CharField(_('Salesperson ID'), blank=True, null=True, max_length=255)
    salesperson_name = models.CharField(_('Salesperson Name'), max_length=255, blank=True, null=True)
    payment_options = models.CharField(_('Payment Options'), max_length=255, blank=True, null=True)
...
class LineItem(TimeStampFlagModelMixin, models.Model):
    ...
    item_id = models.CharField(_('item_id'), max_length=255, blank=True, null=True)
    ...
    item_order = models.CharField(_('Item Order'), max_length=255, blank=True, null=True)
    ...
    item_total = models.FloatField(_('Total'), blank=True, null=True)
