...
from integration.views import (GetBoxTokensView, InventoryView,
                               GetPickListView, GetLeadsCompanyTypeListView,EstimateView,
                               ContactView as ContactViewBooks, CRMContactView, SearchCultivars,
...
from inventory.views import (InventoryViewSet, InventorySyncView,
                             ...
                             InTransitDeleteSyncView, InventoryUpdateView, CategoryNameView, PendingOrderAdminView,InventoryLicenseClientIdView,)
...
urlpatterns = [
    ...
    path(r'inventory/license/client-id', InventoryLicenseClientIdView.as_view(),
         name='inventory_license_client_code'),
