...
PASSWORDLESS_AUTH = {
    ...
    'PASSWORDLESS_MOBILE_MESSAGE':"Do not share this OTP with anyone.Use this code to log in with Thrive Society:%(key)s @{} #%(key)s".format(os.environ.get('OTP_LOGIN_URL')),
