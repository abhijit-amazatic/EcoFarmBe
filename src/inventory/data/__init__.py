...
ORG_ITEM_CUSTOM_FIELD_MAP_TABLE = (
    ...
    ('cf_strain_name',                 'cf_strain_name',                  'cf_strain_name',                   ''),
    ...
    ('cf_lab_test_sample_id',          'cf_lab_test_sample_id',           '',                                 ''),
    ('cf_sample_in_house',             'cf_sample_in_house',              '',                                 ''),
    ('cf_seller_position',             'cf_seller_position',              'cf_lpn',                           ''),
    ...
    ('cf_minimum_quantity',            'cf_minimum_quantity',             '',                                 'cf_minimum_quantity'),
    ...
    ('cf_metrc_source_package_id',     'cf_metrc_source_package_id',      'cf_metrc_source_package_id',       'cf_metrc_source_package_id'),
    ('cf_harvest_date',                'cf_harvest_date',                 '',                                 ''),
    ('cf_market_feedback',             'cf_market_feedback',              '',                                 ''),
    ('cf_available_date',              'cf_available_date',               '',                                 'cf_available_date'),
    ...
    ('cf_cultivar_name',                '',                                'cf_cultivar_name',                 'cf_cultivar_name'),
    ('cf_flowering_period',             '',                                '',                                 'cf_flowering_period'),
    ('cf_clone_date',                   '',                                '',                                 'cf_clone_date'),
    ('cf_lab_sample_id',                '',                                '',                                 'cf_lab_sample_id'),
...
ITEM_CUSTOM_FIELD_ORG_MAP = {
    'efd': { x[0]: x[1] for x in ORG_ITEM_CUSTOM_FIELD_MAP_TABLE },
    'efl': { x[0]: x[2] for x in ORG_ITEM_CUSTOM_FIELD_MAP_TABLE },
    'efn': { x[0]: x[3] for x in ORG_ITEM_CUSTOM_FIELD_MAP_TABLE },
}
