...
def notify_slack_inventory_item_change_submitted(data):
    """
...
def notify_email_inventory_item_change_submitted(data):
    """
    ...
    for email in emails:
        try:
            mail_send(
                "email/notification_inventory_item_change_submitted.html",
                data,
                "New Inventory Item.",
                email,
            )
...
def notify_inventory_item_change_submitted_task(custom_inventory_id):
