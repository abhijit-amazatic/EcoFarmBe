...
class License(TimeStampFlagModelMixin,StatusFlagMixin, models.Model):
    ...
    zoho_books_customer_id = models.CharField(_('Zoho Books Customer ID'), max_length=100, blank=True, null=True)
    zoho_books_vendor_id = models.CharField(_('Zoho Books Vendor ID'), max_length=100, blank=True, null=True)
    documents = GenericRelation(Documents)
