...
class License(TimeStampFlagModelMixin,StatusFlagMixin, models.Model):
    ...
    zoho_books_customer_id_old = models.CharField(_('Zoho Books Customer ID'), max_length=100, blank=True, null=True)
    zoho_books_customer_ids = HStoreField(blank=True, default=dict)
    zoho_books_vendor_id_old = models.CharField(_('Zoho Books Vendor ID'), max_length=100, blank=True, null=True)
    zoho_books_vendor_ids = HStoreField(blank=True, default=dict)
    documents = GenericRelation(Documents)
