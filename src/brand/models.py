...
class Brand(TimeStampFlagModelMixin,models.Model):
    ...
    interested_in_co_branding = models.BooleanField(_('Is Interested In Co-Branding'), default=False)
...
class License(TimeStampFlagModelMixin,models.Model):
    ...
    profile_category = ArrayField(models.CharField(_('This is for Individual user'),max_length=255, blank=True),blank=True, null=True, default=list)
...
class LicenseProfile(TimeStampFlagModelMixin,models.Model):
    ...
    other_distributors = models.BooleanField(_('Work With Other distributors'), default=False)
    transportation = models.BooleanField(_('Have Transportation'), default=False)    
...
class CultivationOverview(models.Model):
    ...
    type_of_nutrients = models.CharField(_('Type of Nutrients'), blank=True, null=True, max_length=255)
