...
class LicenseProfile(TimeStampFlagModelMixin,models.Model):
    ...
    transportation = ArrayField(models.CharField(max_length=255, blank=True, null=True),blank=True, null=True)
...
class CultivationOverview(models.Model):
    ...
    type_of_nutrients = ArrayField(models.CharField(max_length=255,blank=True,null=True),blank=True,null=True)
