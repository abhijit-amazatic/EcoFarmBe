...
CRM_FORMAT  = {
    ...
    "Accounts":{
        ...
        "Shipping_Code": "mailing_address.zip_code_parse",
        ...
        "Billing_Code": "billing_address.zip_code_parse",
    ...
    "Vendors": {
        ...
        "Appellation": "appellation_parse",
        "Transportation_Method": "transportation_parse",
        # "Program_Selection": "program_details_parse",
        "Program_Selection": "signed_program_name",
        "About_Company": "about",
    ...
    "Accounts_To_DB":
        ...
        "billing_address_state": "Billing_State",
        "billing_address_country": "Billing_Country",
        "billing_address_zip_code": "Billing_Code",
        "Do_you_have_a_bank_account": "Do_you_have_a_bank_account",
        "bank_account_number": "Bank_Account_Number",
        "bank_routing_number": "Bank_Routing_Number",
        "bank_name": "Bank_Name",
    ...
    "Cultivars":
        {
            ...
            "CBD_Range": "cbd_range",
            "THC_Range_High": "thc_range_high",
            "THC_Range_Low": "thc_range_low",
            "CBG_Range_High": "cbg_range_high",
            "CBG_Range_Low": "cbg_range_low",
            "THCv_Range_High": "thcv_range_high",
            "THCv_Range_Low": "thcv_range_low",
            "CBD_Range_High": "cbd_range_high",
            "CBD_Range_Low": "cbd_range_low",
...
LICENSE_TYPE_TO_VENDOR_TYPE = {
    'Large Indoor':                         ['Cultivator',],
    'Large Mixed-Light':                    ['Cultivator',],
    'Large Outdoor':                        ['Cultivator',],
    'Medium Indoor':                        ['Cultivator',],
    'Medium Mixed-Light Tier 1':            ['Cultivator',],
    'Medium Mixed-Light Tier 2':            ['Cultivator',],
    'Medium Outdoor':                       ['Cultivator',],
    'Nursery':                              ['Nursery',],
    'Processor':                            ['Cultivator',],
    'Small Indoor':                         ['Cultivator',],
    'Small Mixed-Light Tier 1':             ['Cultivator',],
    'Small Mixed-Light Tier 2':             ['Cultivator',],
    'Small Outdoor':                        ['Cultivator',],
    'Specialty Cottage Indoor':             ['Cultivator',],
    'Specialty Cottage Mixed-Light Tier 1': ['Cultivator',],
    'Specialty Cottage Mixed-Light Tier 2': ['Cultivator',],
    'Specialty Cottage Outdoor':            ['Cultivator',],
    'Specialty Indoor':                     ['Cultivator',],
    'Specialty Mixed-Light Tier 1':         ['Cultivator',],
    'Specialty Mixed-Light Tier 2':         ['Cultivator',],
    'Specialty Outdoor':                    ['Cultivator',],

    'Distributor':                          ['Distribution',],
    'Distributor Transport Only':           ['Distribution',],
    'Event Organizer':                      ['Service Provider',],
    'Manufacturer - Type 6':                ['Manufacturer',],
    'Manufacturer - Type 7':                ['Manufacturer',],
