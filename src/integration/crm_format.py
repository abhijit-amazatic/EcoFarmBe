...
CRM_FORMAT  = {
    ...
    "Vendors": {
        ...
        "Yield_Annual_Bucked_Autoflower_Average": "",
    ...
    "Vendors_To_DB" : {
        ...
        "profile_overview": {
            ...
            'outdoor_full_season.canopy_sqf_parse': 'Canopy_Sqf_Outdoor',
            'outdoor_full_season.no_of_harvest_parse': 'Annual_Harvest_Outdoor',
            'outdoor_full_season.plants_per_cycle_parse': 'Plants_per_Cycle_Outdoor',
            'mixed_light.canopy_sqf_parse': 'Total_Canopy_Space',
            'mixed_light.no_of_harvest_parse': 'Annual_Harvests',
            'How_many_clones_total_will_you_need_for_the_year': 'How_many_clones_total_will_you_need_for_the_year',
            'mixed_light.plants_per_cycle_parse': 'Plants_per_Cycle_Mixed_Light',
            'autoflower_parse': 'Autoflower',
            'outdoor_autoflower.canopy_sqf_parse': 'Canopy_Sqf_Outdoor_Autoflower',
            'outdoor_autoflower.no_of_harvest_parse': 'Annual_Harvests_Autoflower',
            'outdoor_autoflower.plants_per_cycle_parse': 'Plants_per_Cycle_Outdoor_Autoflower',
            'full_season_parse': 'Full_Season',
            'indoor.canopy_sqf_parse': 'Canopy_Sqf_Indoor',
            'indoor.no_of_harvest_parse': 'Harvest_Annual_Indoor',
            'indoor.plants_per_cycle_parse_parse': 'Plants_per_Cycle_Indoor', 
            },
        "processing_config":{
            ...
            'po_mixed_light.avg_yield_pr_sq_ft_parse': 'Yield_Sqf_Average_Mixed_Light',
            'po_mixed_light.yield_per_plant_parse': 'Expected_Yield_Per_Plant',
            'po_mixed_light.flower_yield_percentage_parse': 'Flower',
            'po_mixed_light.small_yield_percentage_parse': 'Smalls',
            'po_mixed_light.trim_yield_percentage_parse': 'Trim',
            'po_outdoor_full_season.avg_yield_pr_sq_ft_parse': 'Yield_Sqf_Average_Outdoor',
            'po_outdoor_full_season.yield_per_plant_parse': 'Yield_Plant_Average_Outdoor',
            'po_outdoor_full_season.flower_yield_percentage_parse': 'Flower_Outdoor',
            'po_outdoor_full_season.small_yield_percentage_parse': 'Smalls_Outdoor',
            'po_outdoor_full_season.trim_yield_percentage_parse': 'Trim_Outdoor',
            'po_outdoor_autoflower.yield_per_plant_parse': 'Yield_Plant_Average_Outdoor_Autoflower',
            'po_outdoor_autoflower.avg_yield_per_sq_ft_parse': 'Yield_Sqf_Average_Outdoor_Autoflower',
            'po_outdoor_autoflower.flower_yield_percentage_parse': 'Tops_Autoflower',
            'po_outdoor_autoflower.small_yield_percentage_parse': 'Smalls_Autoflower',
            'po_outdoor_autoflower.trim_yield_percentage_parse': 'Trim_Autoflowers',
            'po_indoor.yield_per_plant_parse': 'Yield_Plant_Average_Indoor',
            'po_indoor.avg_yield_pr_sq_ft_parse': 'Yield_Sqf_Average_Indoor',
            'po_indoor.flower_yield_percentage_parse': 'Flower_Indoor',
            'po_indoor.small_yield_percentage_parse': 'Smalls_Indoor',
            'po_indoor.trim_yield_percentage_parse': 'Trim_Indoor',
            },
        "financial_details": {
            "fd_annual_revenue_2019": "Yearly_Revenue",
            "fd_yearly_budget": "Yearly_Budget",
            'fd_mixed_light.know_cost_per_sqf_parse': 'Know_your_Cost_per_Sqf',
            'fd_mixed_light.cost_per_sqf_parse': 'Cost_per_Sqf',
            'fd_mixed_light.know_cost_per_lbs_parse': 'Know_your_Cost_per_LB',
            'fd_mixed_light.cost_per_lbs_parse': 'Cost_per_LB',
            'fd_mixed_light.tops_target_price_parse': 'Flower_Target_Price_Lb',
            'fd_mixed_light.small_target_price_parse': 'Smalls_Target_Price_Lb',
            'fd_mixed_light.trim_target_price_parse': 'Trim_Target_Price_Lb',
            'fd_mixed_light.bucked_untrimmed_parse': 'Bucked_Untrimmed_Target_Price_Lb',
            'fd_mixed_light.target_profit_margin_parse': 'Target_Profit_Margin_Mixed_Light',
            'fd_outdoor_full_season.know_cost_per_sqf_parse': 'Know_your_Cost_per_Sqf_Outdoor',
            'fd_outdoor_full_season.cost_per_sqf_parse': 'Cost_per_Sqf_Outdoor',
            'fd_outdoor_full_season.know_cost_per_lbs_parse': 'Know_your_Cost_per_Lb_Outdoor',
            'fd_outdoor_full_season.cost_per_lbs_parse': 'Cost_per_Lb_Outdoor',
            'fd_outdoor_full_season.tops_target_price_parse': 'Target_Price_Lb_Flower_Outdoor',
            'fd_outdoor_full_season.small_target_price_parse': 'Target_Price_Lb_Smalls_Outdoor',
            'fd_outdoor_full_season.bucked_untrimmed_parse': 'Target_Price_Lb_Bucked_Untrimmed_Outdoor',
            'fd_outdoor_full_season.trim_target_price_parse': 'Target_Price_Lb_Trim_Outdoor',
            'fd_outdoor_full_season.target_profit_margin_parse': 'Target_Profit_Margin_Outdoor',
            'fd_outdoor_autoflower.know_cost_per_sqf_parse': 'Know_your_Cost_per_Sqf_Autoflower',
            'fd_outdoor_autoflower.cost_per_sqf_parse': 'Cost_per_Sqf_Autoflower',
            'fd_outdoor_autoflower.know_cost_per_lbs_parse': 'Know_your_Cost_per_Lb_Autoflower',
            'fd_outdoor_autoflower.cost_per_lbs_parse': 'Cost_per_Lb_Autoflower',
            'fd_outdoor_autoflower.small_target_price_parse': 'Target_Price_Lb_Smalls_Autoflower',
            'fd_outdoor_autoflower.tops_target_price_parse': 'Target_Price_Lb_Tops_Autoflower',
            'fd_outdoor_autoflower.trim_target_price_parse': 'Target_Price_Lb_Trim_Autoflower',
            'fd_outdoor_autoflower.bucked_untrimmed_parse': 'Target_Price_Lb_Bucked_Autoflower',
            'fd_outdoor_autoflower.target_profit_margin_parse': 'Target_Profit_Margin_Autoflower',
            'fd_indoor.know_cost_per_lbs_parse': 'Know_your_Cost_per_Lb_Indoor',
            'fd_indoor.cost_per_lbs_parse': 'Cost_per_Lb_Indoor',
            'fd_indoor.know_cost_per_sqf_parse': 'Know_your_Cost_per_Sqf_Indoor',
            'fd_indoor.cost_per_sqf_parse': 'Cost_per_Sqf_Indoor',
            'fd_indoor.tops_target_price_parse': 'Target_Price_Lb_Tops_Indoor',
            'fd_indoor.trim_target_price_parse': 'Target_Price_Lb_Trim_Indoor',
            'fd_indoor.small_target_price_parse': 'Target_Price_Lb_Smalls',
            'fd_indoor.target_profit_margin_parse': 'Target_Profit_Margin_Indoor'
        }
    },
    "Licenses_To_DB": {
            "license_id": "id",
